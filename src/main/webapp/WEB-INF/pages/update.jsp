			...
			<div class="row">
				<div class="col-xs-12">
					...
					<div class="form-group">
							...
							<div class="col-xs-6">
								<input class="form-control" placeholder="Id" name="id" value="${id}" readonly="readonly"/>
							</div>
						...
						<button type="submit" name="upd" class="btn btn-default">Update</button>
					</form>
					<form action="/SpringMVC/homepage/delete/${id}" method="POST" class="form-horizontal">
						<input name="id" type="hidden" value="${id}"/>
						<button type="submit" name="del" class="btn btn-default">Delete</button>							
					</form>
				</div>
			</div>
		</div>
